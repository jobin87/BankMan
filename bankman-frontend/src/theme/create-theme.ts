import { experimental_extendTheme, type Theme } from '@mui/material/styles';
...
export function createTheme(settings: SettingsState): Theme {
   ...
   */
  const theme = experimental_extendTheme(updateTheme, updateComponentsWithSettings(settings), overridesTheme);
